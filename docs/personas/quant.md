...
| …with a PROVABLE bracket (audit-grade) | `s.trace("log", certified=True, support=(jitter, None))` |
...
of magnitude; `certified=True` returns a Gauss–Radau bracket the true value
